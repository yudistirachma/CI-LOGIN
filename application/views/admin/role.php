                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/roleAccess/') . $r['id'] ?>"><span class="badge badge-success">access</span></a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <form action="<?= base_url('admin/role') ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" id="role" name="role" class="form-control" id="role" placeholder="Role name" autofocus>
                    </div>
                </div>
